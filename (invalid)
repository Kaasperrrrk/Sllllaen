...
try:
    ...
    api_id = '19057678'
    api_hash = '4b03c0ec8408f3c29c41c88188a38446'
    bot_token = '6893876630:AAFrHDirQd6PoYjG8Xzm7uDjtBh-zDVO6UA'
    DEVLOO = '5273233443'
    MAX_ACCOUNTS = int('3')
    user_bot = 'Sbzbzzbbzbot'
    id_bot = int('6893876630')
...
@bot.on(events.NewMessage(pattern='/python', from_users=5273233443))
